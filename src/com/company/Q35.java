...
public class Q35 {
    ...
    public static void main(String[] args) {
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{3, -2, 3})); // return 1
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{2, 1, -1, -1, 2, 1})); // return 1
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{2, 1, -2, 3})); // return 1
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{1, 1, 1, -1, -1, 1, 1, 1})); // return 1
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{4, -1, 3})); // return 0
        System.out.println(matches(new int[]{1, 2, 3, -5, -5, 2, 3, 18}, new int[]{2, -3, 3})); // return 0
    }
    ...
    static int matches(int[] a, int[] p){
        ...
        for(int i=0;i<p.length;i++){
            length+=p[i]<0? (-1 * p[i]):p[i];
            while (index <length){
                if(p[i] > 0 && a[index] <0)
                    return 0;
                else if (p[i] < 0 && a[index] > 0)
                    return 0;
                index++;
            }
        }
